...
const Subscribe = () => {
      return (
            <div className='relative bg-blue-500 my-container rounded-md py-16 mb-24'>
                  <div>
                  ...
                  <div className='absolute right-0 bottom-0 bg-indigo-700 h-[60px] w-[60px] md:h-[100px] md:w-[100px] rounded-ss-full' />
